    ...
    <html lang="en" className={`${geist.variable} h-full`}>
      <body className="min-h-full flex flex-col bg-zinc-950 text-zinc-100 antialiased font-[family-name:var(--font-geist)]">
        ...
        <footer className="border-t border-zinc-800/60 py-6 px-4">
          <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-zinc-500">
            <span>
              Built by{" "}
              <span className="text-zinc-300 font-medium">Waqar Hassan</span>
            </span>
